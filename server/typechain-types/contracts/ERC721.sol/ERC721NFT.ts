...
export interface ERC721NFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface ERC721NFT extends BaseContract {
  connect(runner?: ContractRunner | null): ERC721NFT;
  waitForDeployment(): Promise<this>;

  interface: ERC721NFTInterface;
